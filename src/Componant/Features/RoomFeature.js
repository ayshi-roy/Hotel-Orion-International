                ...
                <div className="container mt-5">
                    ...
                    <div className="row mt-5">
                        <div className="col-lg-3 col-md-3 col-12 col-sm-12 mb-4 mt-2 d-flex justify-content-center">
                            <div className=""> 
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 480 480" style={{height:'80px',fill:'red'}}>
                                <g>
                                    <g>
                                        <g>
                                ...
                                <h5 className="mt-3 text-center">Hot/Cold Water</h5>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-3 col-12 col-sm-12 mb-4 mt-2 d-flex justify-content-center">
                            <div className="ml-1">                                 
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{height:'80px',fill:'red'}}>
                                    <g id="outline">
                                ...
                                <h5 className="mt-3 text-center">Fire Exit</h5>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-3 col-12 col-sm-12 mb-4 mt-2 d-flex justify-content-center">
                            <div className="ml-5"> 
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 480 480" style={{height:'80px',fill:'red'}}>
                                ...
                                <h5 className="mt-3 text-center">In-room Phone</h5>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-3 col-12 col-sm-12 mb-4 mt-2 d-flex justify-content-center">
                            <div className=""> 
                                <svg xmlns="http://www.w3.org/2000/svg" id="Line_cutting_cutting_Ex" viewBox="0 0 512 512" data-name="Line cutting cutting Ex" style={{height:'80px',fill:'red'}}>
                                    <g>
                                ...
                                <h5 className="mt-3 text-center">24/7 Elevator</h5>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-3 col-12 col-sm-12 mb-4 mt-2 d-flex justify-content-center">
                            <div className=""> 
                                ...
                                <h5 className="mt-3 text-center">Air Condition</h5>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-3 col-12 col-sm-12 mb-4 mt-2 d-flex justify-content-center">
                            <div className=""> 
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 393.338 393.338" style={{height:'80px',fill:'red'}}>
                                ...
                                <h5 className="mt-3 text-center">Flat Screen</h5>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-3 col-12 col-sm-12 mb-4 mt-2 d-flex justify-content-center">
                            <div className=""> 
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" style={{height:'80px',fill:'red'}}>
                                    <g>
                                        <g>
                                ...
                                <h5 className="mt-3 text-center">Hair Dryer</h5>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-3 col-12 col-sm-12 mb-4 mt-2 d-flex justify-content-center">
                            <div className=""> 
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" style={{height:'80px',fill:'red'}}>
                                ...
                                <h5 className="mt-3 text-center">Room Service</h5>
                            </div>
                        </div>
                    </div>
                </div>
